  ...
  return (
    <>
      ...
      <div className={formModal || confirmation ? "wrapper" : ""}>
        <header className="header">
          <nav className="navBar">
            ...
            <ul className="navList">
              ...
              {/* <li className="navList__item">
                <Link to={"/360tours"}>360 tours</Link>
              </li> */}
              <li className="navList__item">
        ...
        {/* {isMobile ? <div className="hr"> </div> : ""} */}
        <div className={menu ? "mobileNavList" : "d-none mobileNavList"}>
          <ul className="mobileNavList__list">
            <li className="navList__item">
              <Link to={"/artists"}>artists</Link>
            </li>
            <li className="navList__item">
        ...
        {menu === false ? (
          <footer className="footer">
            ...
            <div className="footer_info">
              <div className="credentials">2022 - CDA Gallery/Legal</div>
              <button
                onClick={() => setformModal(!formModal)}
                className="subscribe"
              >
        ...
        <FontAwesomeIcon
          ...
          className={
            scrollPos > 300 ? "scrollUpThePage " : " scrollUpThePage d-none"
          }
          icon={faChevronUp}
        />
      </div>
